                ...
                <div className="modal-content">
                    <form>
                        ...
                        <div className="row">
                            ...
                            id="search-input-name" classes="col l10 offset-l1 s12" label="Manga Name"/>
                            
                            <InputField type="text" placeholder="Enter Author Name"
                            id="search-input-author" classes="col l10 offset-l1 s12" label="Author Name"/>
                            ...
                            <div className="input-field col s12 l10 offset-l1">
                                ...
                                <label htmlFor="search-to-date">From</label>
                            </div>
